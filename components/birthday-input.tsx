...
export function BirthdayInput({ onBirthdayChange }: BirthdayInputProps) {
  ...
  useEffect(() => {
    if (day && month && year) {
      ...
      const yearNum = Math.min(parseInt(year, 10), 2025);
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        >
          ...
          <Select value={month} onValueChange={setMonth}>
            <SelectTrigger
              id="month"
              className="bg-white text-gray-700 dark:bg-gray-700 border-gray-300 dark:border-gray-600"
            >
        ...
        >
          ...
          <div className="relative">
            <Input
              ...
              placeholder="YYYY"
              className="bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 pl-8 no-spinner"
            />
            <Calendar
              className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-400"
              size={16}
